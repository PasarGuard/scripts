...
install_shared_libs_from_local() {
    ...
    install -m 644 "$source_dir/lib/common.sh" "$SHARED_LIB_INSTALL_DIR/common.sh"
    if [ -f "$source_dir/lib/env.sh" ]; then
        install -m 644 "$source_dir/lib/env.sh" "$SHARED_LIB_INSTALL_DIR/env.sh"
    fi
}
...
install_shared_libs_from_repo() {
    ...
    curl -fsSL "https://github.com/${fetch_repo}/raw/main/lib/common.sh" -o "$tmp_dir/common.sh"
    install -m 644 "$tmp_dir/common.sh" "$SHARED_LIB_INSTALL_DIR/common.sh"

    curl -fsSL "https://github.com/${fetch_repo}/raw/main/lib/env.sh" -o "$tmp_dir/env.sh"
    install -m 644 "$tmp_dir/env.sh" "$SHARED_LIB_INSTALL_DIR/env.sh"
